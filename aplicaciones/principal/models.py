...
class Persona(models.Model):
    ...
    url_selfi = models.ImageField(upload_to='images/selfie/', default='images/selfie/no-img.jpg')
    url_documento = models.ImageField(upload_to='images/doc/', default='images/doc/no-img.jpg')
